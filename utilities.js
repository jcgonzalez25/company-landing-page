...
var Utilities = {
  slideTo: function(divSection){
    ...
    var element          = document.querySelector(divSection);
    var applicationState = element;
    var navbarSize       = document.querySelector("#myNavbar").offsetHeight.toString() + "px";
    if(divSection == ".what_we_do" || divSection == ".footage" || divSection == ".contactus")
      scrollIt(element,500,'easeOutQuad');

  },
  getSectionDivs: function(){
